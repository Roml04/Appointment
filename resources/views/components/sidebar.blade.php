...
<nav class="cstm-sidebar flex flex-col w-1/5 gap-12">
    ...
    <div class="flex flex-col gap-5">
        ...
        {{-- component --}}
        <button class="py-2 rounded-full hover:text-blue-500">Log Out</button>
    </div>
    ...
    <ul class="flex flex-col gap-6">
        ...
        <li class="group rounded-full w-full">
            <a class="px-10 py-2.5 h-full w-full group-hover:text-blue-500 gap-2" href="{{ route('auth.appointments.index') }}">
        ...
        {{-- <li class="group rounded-full hover:bg-blue-500 w-full">
            <a class="px-10 py-2.5 h-full w-full group-hover:text-white gap-2" href="{{ route('auth.dashboard') }}">
        ...
        <li class="group rounded-full hover:bg-blue-500 w-full">
            <a class="px-10 py-2.5 h-full w-full group-hover:text-white gap-2" href="{{ route('auth.doctors.index') }}">
        ...
        <li class="group rounded-full hover:bg-blue-500 w-full">
            <a class="px-10 py-2.5 h-full w-full group-hover:text-white gap-2" href="{{ route('auth.appointments.index') }}">
