        ...
        <section class="flex flex-col w-full">
            ...
            <div class="flex p-6 gap-10 h-fit">
                <div class="w-fit h-fit flex flex-col">
                    <h2 class="pb-2.5">Status</h2>
                    <div class="flex flex-col gap-5 flex-1">
                        <a href="{{ route('auth.doctors.index') }}" class="flex gap-20 w-fit items-center px-5">
                            <div>
                                <strong>{{ $dashBoardInfo['numOfDoctors'] }}</strong>
                                <p class="text-nowrap">All Doctors</p>
                            </div>
                        ...
                        <a href="" class="flex gap-20 w-fit items-center px-5">
                            <div>
                                <strong>{{ $dashBoardInfo['numOfPatients'] }}</strong>
                                <p class="text-nowrap">All Patients</p>
                            </div>
                ...
                <div class="w-full">
                    <h2 class="pb-2.5">Upcoming Appointments</h2>
                        ...
                        <tbody>
                            @foreach($incomingAppointments as $appointment)
                                <tr class="hover:bg-blue-100">
                                    <td><a class="py-2.5 flex justify-center" href="{{ route('auth.appointment.display', ["appointment_id" => $appointment['id']]) }}"><p class="w-full text-center text-nowrap overflow-hidden text-ellipsis px-2.5">{{ $appointment['id'] }}</p></a></td>
                                    <td><a class="py-2.5 flex justify-center" href="{{ route('auth.appointment.display', ["appointment_id" => $appointment['id']]) }}"><p class="w-full text-center text-nowrap overflow-hidden text-ellipsis px-2.5">{{ $appointment['appointment_type'] }}</p></a></td>
                                    <td><a class="py-2.5 flex justify-center" href="{{ route('auth.appointment.display', ["appointment_id" => $appointment['id']]) }}"><p class="w-full text-center text-nowrap overflow-hidden text-ellipsis px-2.5">{{ $appointment['docFullName'] }}</p></a></td>
                                    <td><a class="py-2.5 flex justify-center" href="{{ route('auth.appointment.display', ["appointment_id" => $appointment['id']]) }}"><p class="w-full text-center text-nowrap overflow-hidden text-ellipsis px-2.5">{{ $appointment['appointment_date'] }}</p></a></td>
                                </tr>
                            @endforeach
                        </tbody>
